...
export const metadata = {
  ...
  description:
    "Chơi game nối từ online cùng nhau, chơi ghép chữ cùng nhau, chơi solo theo cặp hoặc theo nhóm nhiều người. Đánh bại các đối thủ và trở thành người chơi còn lại cuối cùng để giành chiến thắng",
  keywords: [
    "Chơi nối từ online",
